...
const bankOfQuestions = [
  {
    question:
      "What country is associated with Roast Beef and Yorkshire Pudding?",
    answer: ["Mexico", "France", "England", "Guatemala"],
    correctAnswer: 2,
  },
  {
    question: "Where is the home of the massaman curry?",
    answer: ["Thailand", "Malaysia", "Japan", "Wales"],
    correctAnswer: 0,
  },
  {
    question: "Where does Kiwi fruit originate?",
    answer: ["Portugal", "New Zealand", "Australia", "Singapore"],
    correctAnswer: 1,
  },
];
...
function getResults() {
  ...
  document.getElementById(
    "final_score"
  ).innerText = `You have scored ${correctAnswerCount}`;
}
